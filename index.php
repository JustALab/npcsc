  ...
  <body class="bg-light">
    ...
    <div class="container-fluid">
      ...
      <div id="about" class="section container">
        <ul>
          <br>
          <li><i class="fa fa-chevron-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;NarpaviCSC Started in 2018, Headquartered in Madurai.</li>
          <br>
          <li><i class="fa fa-chevron-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;NarpaviCSC is a network of Common Service Centre’s to facilitate e-Services accessible to 92% Citizens who still doesn’t have internet or online banking facilities.</li>
          <br>
        ...
        <div class="row" style="font-size: 13px;">
          <div class="col-sm-12 col-md-6 col-lg-4">
            ...
            <ul style="padding-top: 20px;">
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;OneStop for all e-Services</li>
              <br>
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Service Guarantee</li>
              <br>
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Essential day-day Services</li>
              <br>
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Hands on Training</li>
              <br>
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Customer Profiling</li>
              <br>
            </ul>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-4">
            ...
            <ul style="padding-top: 20px;">
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Technical Support</li>
              <br>
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Marketing Support</li>
              <br>
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Business Facilitation</li>
              <br>
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;e-BO Growth Planning</li>
              <br>
              <li> <i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;New Service Support</li>
              <br>
            </ul>
          </div>
          <div class="col-sm-12 col-md-6 col-lg-4">
            ...
            <ul style="padding-top: 20px;">
              <li><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Servicing your own Citizens</li>
              <br>
              <li><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Creating Awareness</li>
              <br>
              <li><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Cross & Upselling Platform </li>
              <br>
              <li><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Bringing People together</li>
              <br>
              <li><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;Recognition in your Society</li>
              <br>
            </ul>
          </div>
          <!-- 
      ...
      <div id="who" class="section container" >
        <ul style="list-style-type: none;">
          <br>
          <li><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;  Highly motivated business aspirants (any degree) with Computer skills. OR </li>
          <br>
          <li><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;  Existing retail business owners with PC Skills who would like to expand their business profits. OR</li>
          <br>
          <li><i class="fa fa-check-square"></i>&nbsp;&nbsp;&nbsp;  Ex-Service Men, Women Entrepreneurs, Differently Abled Graduates with PC Skills.</li>
          <br>
          <br>
      ...
      <div id="contact" class="section container" style="font-size: 15px">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6">
            <p><i class="fa fa-phone"></i> 90929 31221</p>
            <p><i class="fa fa-phone"></i> 0452-4981511</p>
            <p><i class="fa fa-envelope-o"></i>  arulmiguratha@gmail.com</p>
          </div>
        </div>
      </div>
    </div>
