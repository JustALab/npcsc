    ...
    <div class="card">
      ...
      <div class="card-body">
        <table id="gst_table" class="table table-bordered table-hover">
          ...
          <tbody>
            <?php
                $query = 'SELECT * FROM '.TABLE_GST_APP.' WHERE user_id="'.$_SESSION['user_id'].'" AND status="'.$status.'" ORDER BY application_no DESC';
                ...
                if(mysqli_num_rows($result) > 0){
                  ...
                  while($row = mysqli_fetch_assoc($result)){
                    ...
                    echo "<td><a href='view_gst_registration.php?application_no=".$row['application_no']."'>View</a></td>";
                    echo "</tr>";
                  }
                }
            ?>
