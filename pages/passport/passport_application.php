          ...
          <div class="col-sm-4">
            <div class="form-group">
                  ...
                  <select id="service_type" name="service_type" class="form-control required">
                      ...
                      <option value="Fresh">Re-issue(Renewal)</option>
                      <option value="Children">Children(Below 18 years)</option>
                      <option value="Children">Children Renewal(Below 18 years)</option>
                    </select>
                </div>
            </div>
            <div class="col-sm-4">
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
                  ...
                  <select id="age_id_proof" name="age_id_proof" class="form-control required">
                    ...
                    Applicant(Goverment Servants)</option>
                    </select>
                </div>
            </div>
            <div class="col-sm-4">
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
                  <label>Upload Age/ID Proof</label>
                   <input type="file" class="required" id="age_id_proof_file" name="age_id_proof_file"  accept=".jpg,.JPG,.JPEG,.jpeg">
                </div>
            </div>
            <div class="col-sm-4">
            <div class="form-group">
      ...
      <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
                  ...
                  <input type="number" id="old_passport_no" name="old_passport_no" class="form-control required" placeholder="Old Passport Number">
                </div>
            </div>
            <div class="col-sm-4">
            <div class="form-group">
