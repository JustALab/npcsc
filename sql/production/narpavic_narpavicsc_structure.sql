...
--
-- Host: localhost:3306
-- Generation Time: Jul 19, 2018 at 08:07 AM
...
ALTER TABLE `passport_application`
  ADD PRIMARY KEY (`application_no`),
  ADD KEY `passport_application_ibfk_1` (`user_id`);
...
--
ALTER TABLE `price_config`
  MODIFY `price_config_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
